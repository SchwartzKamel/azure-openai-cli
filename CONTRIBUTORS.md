...
Hello! Contributor! Hello! We're glad you're here.
...
Your name lands here automatically the first time one of your contributions
is merged. Specifically, we look at:

- The **git author** of merged commits.
- Any **`Co-authored-by:` trailers** in the commit message. This is how we
  credit pair-programming partners, reviewers who rewrote a chunk for you,
  and AI assistants when you used one.
