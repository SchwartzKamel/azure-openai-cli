...
public class RalphWorkflowTests
{
    ...
    {
        return AzureOpenAI_CLI_V2.Ralph.RalphWorkflow.RunAsync(
            chatClient,
            taskPrompt: task,
    ...
    public void Checkpoint_WriteFailure_EmitsTraceMessage()
    {
        ...
        try
        {
            ...
            AzureOpenAI_CLI_V2.Ralph.CheckpointManager.WriteFinalEntry("final");
    ...
    public void Workflow_BuildsAgentOutsideIterationLoop()
    {
        ...
        var asm = typeof(AzureOpenAI_CLI_V2.Ralph.RalphWorkflow).Assembly;
    ...
    private static string FindSourceFile(string leaf)
    {
        ...
        // azureopenai-cli-v2/Ralph directory.
        var dir = new DirectoryInfo(AppContext.BaseDirectory);
        while (dir != null)
        {
            var candidate = Path.Combine(dir.FullName, "azureopenai-cli-v2", "Ralph", leaf);
