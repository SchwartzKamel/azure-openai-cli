...
/// <c>az-ai --version --short</c> reported the wrong version on the v2.0.4
/// tag and <c>brew test az-ai</c> would fail against the published tarballs.
///
...
public class VersionContractTests
{
    ...
    public void VersionFull_contains_semver_and_framework_tag()
    {
        ...
        Assert.Contains("az-ai", Program.VersionFull);
    ...
    private static string LocateCsproj()
    {
        ...
        throw new FileNotFoundException(
            "AzureOpenAI_CLI.csproj not found walking up from " + AppContext.BaseDirectory);
    }
}
