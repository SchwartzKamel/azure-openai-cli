...
public class V2FlagParityTests
{
    ...
    public void SquadCoordinator_Route_PicksHighestScore()
    {
        ...
        var cfg = new AzureOpenAI_CLI.Squad.SquadConfig();
        cfg.Personas.Add(new AzureOpenAI_CLI.Squad.PersonaConfig
        {
            Name = "coder",
            Role = "Coder",
        ...
        cfg.Routing.Add(new AzureOpenAI_CLI.Squad.RoutingRule
        {
        ...
        var coord = new AzureOpenAI_CLI.Squad.SquadCoordinator(cfg);
    ...
    public void PersonaMemory_ReadHistory_EmptyWhenMissing()
    {
        ...
        var mem = new AzureOpenAI_CLI.Squad.PersonaMemory();
