...
| costanza-2026-05-S03E30-3 | [s03e30-the-audit-trilogy.md#not-shipped](exec-reports/s03e30-the-audit-trilogy.md#not-shipped) | MEDIUM | open | Costanza | Program.cs mode dispatch cyclomatic complexity; audit flagged complexity around standard / agent / ralph / persona / image mode routing. Refactor to small dispatcher. | 2026-05-13 |
| jerry-2026-05-S03E30-1 | [s03e30-the-audit-trilogy.md#not-shipped](exec-reports/s03e30-the-audit-trilogy.md#not-shipped) | MEDIUM | open | Jerry | Node-20 era GitHub Actions major versions pinned to v3/v4 (e.g., `actions/upload-artifact@v3`, `actions/cache@v3`) entering EOL; audit recommends own future episode to bump ecosystem-wide. | 2026-05-13 |
| kramer-2026-05-S03E30-2 | [s03e30-the-audit-trilogy.md#not-shipped](exec-reports/s03e30-the-audit-trilogy.md#not-shipped) | MEDIUM | open | Kramer | `--doctor` tool and preset coverage expansion; audit flagged gaps in coverage. | 2026-05-13 |
| kramer-2026-05-S03E30-4 | [s03e30-the-audit-trilogy.md#not-shipped](exec-reports/s03e30-the-audit-trilogy.md#not-shipped) | MEDIUM | open | Kramer | Program.cs error-handling consistency sweep; some paths still use inline `Console.Error.WriteLine` + `Environment.Exit` instead of project's `ErrorAndExit` helper; convert remaining paths. | 2026-05-13 |
| newman-2026-05-S03E30-5 | [s03e30-the-audit-trilogy.md#not-shipped](exec-reports/s03e30-the-audit-trilogy.md#not-shipped) | MEDIUM | open | Newman | SECURITY.md supported versions table drift lint or skill; audit caught table claiming 2.0.x active when csproj is 2.2.0; add doc-lint rule, make target, or skill to catch table drift. | 2026-05-13 |
